...
_TEXT_FORMAT = (
    ...
    "execution_id=%(execution_id)s task_id=%(task_id)s | %(message)s"
)


class _ContextFilter(logging.Filter):
    """Inject execution_id / task_id from context vars onto every record."""
...
def bind_log_context(
    execution_id: Optional[object] = None, task_id: Optional[object] = None
) -> None:
